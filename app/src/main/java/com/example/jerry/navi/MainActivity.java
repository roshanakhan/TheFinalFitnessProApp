...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MainActivity.this,"The reminder notification is opened.",Toast.LENGTH_LONG).show();
    ...
    public void gotoVideo(){
        Intent gotoVideo = new Intent(this,VideoMainActivity.class);
        startActivity(gotoVideo);
    }
    public void gotoFeedback(){
        Intent gotoFeedback = new Intent(this,feedbackMainActivity.class);
        startActivity(gotoFeedback);
    }
    public void gotoMusicPlayer() {
        Intent gotoMusicPlayer = new Intent(MainActivity.this, MusicPlayer.class);
    ...
    public void startStepsCounter(){
        Intent intent = new Intent(this, steps_counter_activity.class);
        startActivity(intent);
    }
    @Override
